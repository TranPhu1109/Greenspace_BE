...
namespace GreenSpace.Infrastructure.Migrations
{
    ...
    [Migration("20250504063816_UpdateV36")]
    partial class UpdateV36
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GreenSpace.Domain.Entities.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GreenSpace.Domain.Entities.Complaint", b =>
                {
                    ...
                    b.Property<Guid?>("ComplaintReasonId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GreenSpace.Domain.Entities.ComplaintReason", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GreenSpace.Domain.Entities.ExternalProducts", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GreenSpace.Domain.Entities.ServiceOrder", b =>
                {
                    ...
                    b.Property<DateOnly?>("ContructionDate")
                        .HasColumnType("date");

                    b.Property<decimal>("ContructionPrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<TimeOnly?>("ContructionTime")
                        .HasColumnType("time");
                    ...
                    b.Property<string>("ReportAccoutant")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReportManger")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SkecthReport")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GreenSpace.Domain.Entities.TransactionPercentage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TransactionPercentage");
                });
            ...
            modelBuilder.Entity("GreenSpace.Domain.Entities.Complaint", b =>
                {
                    b.HasOne("GreenSpace.Domain.Entities.ComplaintReason", "ComplaintReason")
                        .WithMany()
