...
namespace GreenSpace.WebAPI.Controllers
{
    ...
    public class ServiceFeedbackController : ControllerBase
    {
        ...
        [ProducesResponseType((int)HttpStatusCode.InternalServerError)]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ServiceFeedbackCreateModel model)
        {
        ...
        [ProducesResponseType((int)HttpStatusCode.InternalServerError)]
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] ServiceFeedbackUpdateModel model)
        {

            var result = await _mediator.Send(new UpdateServiceFeedBackCommand { Id = id, UpdateModel = model });
            if (!result)
            {
