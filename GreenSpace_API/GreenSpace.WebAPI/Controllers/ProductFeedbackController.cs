...
namespace GreenSpace.WebAPI.Controllers
{
    ...
    public class ProductFeedbackController : ControllerBase
    {
        ...
        [ProducesResponseType((int)HttpStatusCode.InternalServerError)]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ProductFeedbackCreateModel model)
        {
        ...
        [ProducesResponseType((int)HttpStatusCode.InternalServerError)]
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] ProductFeedbackUpdateModel model)
        {
       
            var result = await _mediator.Send(new UpdateProductFeedBackCommand { Id = id, UpdateModel = model });
            if (!result)
            {
